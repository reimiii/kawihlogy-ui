...
export class DefaultApi extends runtime.BaseAPI {
  ...
  async authLoginPostRaw(
    requestParameters: AuthLoginPostOperationRequest,
    ...
    const response = await this.request(
      {
        ...
        body: AuthLoginPostRequestToJSON(
   ...
   * profile
   */
  async authProfileGetRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<AuthProfileGet200Response>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      AuthProfileGet200ResponseFromJSON(jsonValue),
    );
  }
  ...
  async authProfileGet(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<AuthProfileGet200Response> {
  ...
  async authRegisterPostRaw(
    requestParameters: AuthRegisterPostOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<AuthRegisterPost201Response>> {
    const queryParameters: any = {};
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: AuthRegisterPostRequestToJSON(
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      AuthRegisterPost201ResponseFromJSON(jsonValue),
    );
  }
  ...
  async authRegisterPost(
    requestParameters: AuthRegisterPostOperationRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<AuthRegisterPost201Response> {
   ...
   */
  async journalGetRaw(
    requestParameters: JournalGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<JournalGet200Response>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      JournalGet200ResponseFromJSON(jsonValue),
    );
  }
   ...
   * create
   */
  async journalPostRaw(
    requestParameters: JournalPostOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
   ...
   * delete
   */
  async journalUuidDeleteRaw(
    requestParameters: JournalUuidDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
   ...
   * findOne
   */
  async journalUuidGetRaw(
    requestParameters: JournalUuidGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<JournalUuidGet200Response>> {
    if (requestParameters["uuid"] == null) {
      throw new runtime.RequiredError(
        "uuid",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      JournalUuidGet200ResponseFromJSON(jsonValue),
    );
  }
   ...
   * findOne
   */
  async journalUuidGet(
    requestParameters: JournalUuidGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<JournalUuidGet200Response> {
    const response = await this.journalUuidGetRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * update
   */
  async journalUuidPatchRaw(
    requestParameters: JournalUuidPatchOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters["uuid"] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: JournalUuidPatchRequestToJSON(
          requestParameters["journalUuidPatchRequest"],
        ),
      },
      initOverrides,
    );
   ...
   * generate poem audio
   */
  async poemIdAudioPostRaw(
    requestParameters: PoemIdAudioPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<PoemPost202Response>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PoemPost202ResponseFromJSON(jsonValue),
    );
  }
   ...
   * generate poem audio
   */
  async poemIdAudioPost(
    requestParameters: PoemIdAudioPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<PoemPost202Response> {
    const response = await this.poemIdAudioPostRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * delete
   */
  async poemIdDeleteRaw(
    requestParameters: PoemIdDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
   ...
   * delete file
   */
  async poemIdFileDeleteRaw(
    requestParameters: PoemIdFileDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
   ...
   */
  async poemPostRaw(
    requestParameters: PoemPostOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<PoemPost202Response>> {
    const queryParameters: any = {};
