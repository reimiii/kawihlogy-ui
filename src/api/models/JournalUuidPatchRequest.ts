 ...
 * 
 * @export
 * @interface JournalUuidPatchRequest
 */
export interface JournalUuidPatchRequest {
    /**
     * 
     * @type {string}
     * @memberof JournalUuidPatchRequest
     */
    content?: string;
    /**
     * 
...
/**
 * Check if a given object implements the JournalUuidPatchRequest interface.
 */
export function instanceOfJournalUuidPatchRequest(value: object): value is JournalUuidPatchRequest {
    return true;
}

export function JournalUuidPatchRequestFromJSON(json: any): JournalUuidPatchRequest {
    return JournalUuidPatchRequestFromJSONTyped(json, false);
}

export function JournalUuidPatchRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): JournalUuidPatchRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function JournalUuidPatchRequestToJSON(json: any): JournalUuidPatchRequest {
    return JournalUuidPatchRequestToJSONTyped(json, false);
}

export function JournalUuidPatchRequestToJSONTyped(value?: JournalUuidPatchRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
