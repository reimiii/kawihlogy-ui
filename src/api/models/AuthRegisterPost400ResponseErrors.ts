...
import type { AuthRegisterPost400ResponseErrorsFieldErrors } from './AuthRegisterPost400ResponseErrorsFieldErrors';
import {
    AuthRegisterPost400ResponseErrorsFieldErrorsFromJSON,
    AuthRegisterPost400ResponseErrorsFieldErrorsFromJSONTyped,
    AuthRegisterPost400ResponseErrorsFieldErrorsToJSON,
    AuthRegisterPost400ResponseErrorsFieldErrorsToJSONTyped,
} from './AuthRegisterPost400ResponseErrorsFieldErrors';

/**
 * 
 * @export
 * @interface AuthRegisterPost400ResponseErrors
 */
export interface AuthRegisterPost400ResponseErrors {
    /**
     * 
     * @type {Array<any>}
     * @memberof AuthRegisterPost400ResponseErrors
     */
    formErrors?: Array<any>;
    /**
     * 
     * @type {AuthRegisterPost400ResponseErrorsFieldErrors}
     * @memberof AuthRegisterPost400ResponseErrors
     */
    fieldErrors?: AuthRegisterPost400ResponseErrorsFieldErrors;
}

/**
 * Check if a given object implements the AuthRegisterPost400ResponseErrors interface.
 */
export function instanceOfAuthRegisterPost400ResponseErrors(value: object): value is AuthRegisterPost400ResponseErrors {
    return true;
}

export function AuthRegisterPost400ResponseErrorsFromJSON(json: any): AuthRegisterPost400ResponseErrors {
    return AuthRegisterPost400ResponseErrorsFromJSONTyped(json, false);
}

export function AuthRegisterPost400ResponseErrorsFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthRegisterPost400ResponseErrors {
    if (json == null) {
        return json;
    }
    return {
        ...
        'fieldErrors': json['fieldErrors'] == null ? undefined : AuthRegisterPost400ResponseErrorsFieldErrorsFromJSON(json['fieldErrors']),
    };
}

export function AuthRegisterPost400ResponseErrorsToJSON(json: any): AuthRegisterPost400ResponseErrors {
    return AuthRegisterPost400ResponseErrorsToJSONTyped(json, false);
}

export function AuthRegisterPost400ResponseErrorsToJSONTyped(value?: AuthRegisterPost400ResponseErrors | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'fieldErrors': AuthRegisterPost400ResponseErrorsFieldErrorsToJSON(value['fieldErrors']),
    };
}
