 ...
 * 
 * @export
 * @interface JournalPost400ResponseErrorsFieldErrors
 */
export interface JournalPost400ResponseErrorsFieldErrors {
    /**
     * 
     * @type {Array<string>}
     * @memberof JournalPost400ResponseErrorsFieldErrors
     */
...
/**
 * Check if a given object implements the JournalPost400ResponseErrorsFieldErrors interface.
 */
export function instanceOfJournalPost400ResponseErrorsFieldErrors(value: object): value is JournalPost400ResponseErrorsFieldErrors {
    return true;
}

export function JournalPost400ResponseErrorsFieldErrorsFromJSON(json: any): JournalPost400ResponseErrorsFieldErrors {
    return JournalPost400ResponseErrorsFieldErrorsFromJSONTyped(json, false);
}

export function JournalPost400ResponseErrorsFieldErrorsFromJSONTyped(json: any, ignoreDiscriminator: boolean): JournalPost400ResponseErrorsFieldErrors {
    if (json == null) {
        return json;
    }
    return {
...
export function JournalPost400ResponseErrorsFieldErrorsToJSON(json: any): JournalPost400ResponseErrorsFieldErrors {
    return JournalPost400ResponseErrorsFieldErrorsToJSONTyped(json, false);
}

export function JournalPost400ResponseErrorsFieldErrorsToJSONTyped(value?: JournalPost400ResponseErrorsFieldErrors | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
