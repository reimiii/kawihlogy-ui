 ...
 * 
 * @export
 * @interface JournalGet200ResponseItemsInner
 */
export interface JournalGet200ResponseItemsInner {
    /**
     * 
     * @type {string}
     * @memberof JournalGet200ResponseItemsInner
     */
    id?: string;
    /**
     * 
...
/**
 * Check if a given object implements the JournalGet200ResponseItemsInner interface.
 */
export function instanceOfJournalGet200ResponseItemsInner(value: object): value is JournalGet200ResponseItemsInner {
    return true;
}

export function JournalGet200ResponseItemsInnerFromJSON(json: any): JournalGet200ResponseItemsInner {
    return JournalGet200ResponseItemsInnerFromJSONTyped(json, false);
}

export function JournalGet200ResponseItemsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): JournalGet200ResponseItemsInner {
    if (json == null) {
        return json;
    }
    return {
...
export function JournalGet200ResponseItemsInnerToJSON(json: any): JournalGet200ResponseItemsInner {
    return JournalGet200ResponseItemsInnerToJSONTyped(json, false);
}

export function JournalGet200ResponseItemsInnerToJSONTyped(value?: JournalGet200ResponseItemsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
