 ...
 * 
 * @export
 * @interface AuthRegisterPost400ResponseErrorsFieldErrors
 */
export interface AuthRegisterPost400ResponseErrorsFieldErrors {
    /**
     * 
     * @type {Array<string>}
     * @memberof AuthRegisterPost400ResponseErrorsFieldErrors
     */
    email?: Array<string>;
    /**
     * 
...
/**
 * Check if a given object implements the AuthRegisterPost400ResponseErrorsFieldErrors interface.
 */
export function instanceOfAuthRegisterPost400ResponseErrorsFieldErrors(value: object): value is AuthRegisterPost400ResponseErrorsFieldErrors {
    return true;
}

export function AuthRegisterPost400ResponseErrorsFieldErrorsFromJSON(json: any): AuthRegisterPost400ResponseErrorsFieldErrors {
    return AuthRegisterPost400ResponseErrorsFieldErrorsFromJSONTyped(json, false);
}

export function AuthRegisterPost400ResponseErrorsFieldErrorsFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthRegisterPost400ResponseErrorsFieldErrors {
    if (json == null) {
        return json;
    }
    return {
...
export function AuthRegisterPost400ResponseErrorsFieldErrorsToJSON(json: any): AuthRegisterPost400ResponseErrorsFieldErrors {
    return AuthRegisterPost400ResponseErrorsFieldErrorsToJSONTyped(json, false);
}

export function AuthRegisterPost400ResponseErrorsFieldErrorsToJSONTyped(value?: AuthRegisterPost400ResponseErrorsFieldErrors | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
