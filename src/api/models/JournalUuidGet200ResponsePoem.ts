...
import type { JournalUuidGet200ResponsePoemContent } from './JournalUuidGet200ResponsePoemContent';
import {
    JournalUuidGet200ResponsePoemContentFromJSON,
    JournalUuidGet200ResponsePoemContentFromJSONTyped,
    JournalUuidGet200ResponsePoemContentToJSON,
    JournalUuidGet200ResponsePoemContentToJSONTyped,
} from './JournalUuidGet200ResponsePoemContent';
import type { JournalUuidGet200ResponsePoemFile } from './JournalUuidGet200ResponsePoemFile';
import {
    JournalUuidGet200ResponsePoemFileFromJSON,
    JournalUuidGet200ResponsePoemFileFromJSONTyped,
    JournalUuidGet200ResponsePoemFileToJSON,
    JournalUuidGet200ResponsePoemFileToJSONTyped,
} from './JournalUuidGet200ResponsePoemFile';

/**
 * 
 * @export
 * @interface JournalUuidGet200ResponsePoem
 */
export interface JournalUuidGet200ResponsePoem {
    /**
     * 
     * @type {string}
     * @memberof JournalUuidGet200ResponsePoem
     */
    id?: string;
    /**
     * 
     * @type {JournalUuidGet200ResponsePoemContent}
     * @memberof JournalUuidGet200ResponsePoem
     */
    content?: JournalUuidGet200ResponsePoemContent;
    /**
     * 
     * @type {JournalUuidGet200ResponsePoemFile}
     * @memberof JournalUuidGet200ResponsePoem
     */
    file?: JournalUuidGet200ResponsePoemFile | null;
    /**
     * 
     * @type {Date}
     * @memberof JournalUuidGet200ResponsePoem
...
/**
 * Check if a given object implements the JournalUuidGet200ResponsePoem interface.
 */
export function instanceOfJournalUuidGet200ResponsePoem(value: object): value is JournalUuidGet200ResponsePoem {
    return true;
}

export function JournalUuidGet200ResponsePoemFromJSON(json: any): JournalUuidGet200ResponsePoem {
    return JournalUuidGet200ResponsePoemFromJSONTyped(json, false);
}

export function JournalUuidGet200ResponsePoemFromJSONTyped(json: any, ignoreDiscriminator: boolean): JournalUuidGet200ResponsePoem {
    if (json == null) {
        return json;
    }
    return {
        ...
        'content': json['content'] == null ? undefined : JournalUuidGet200ResponsePoemContentFromJSON(json['content']),
        'file': json['file'] == null ? undefined : JournalUuidGet200ResponsePoemFileFromJSON(json['file']),
        'createdAt': json['createdAt'] == null ? undefined : (new Date(json['createdAt'])),
        'updatedAt': json['updatedAt'] == null ? undefined : (new Date(json['updatedAt'])),
    };
}

export function JournalUuidGet200ResponsePoemToJSON(json: any): JournalUuidGet200ResponsePoem {
    return JournalUuidGet200ResponsePoemToJSONTyped(json, false);
}

export function JournalUuidGet200ResponsePoemToJSONTyped(value?: JournalUuidGet200ResponsePoem | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'id': value['id'],
        'content': JournalUuidGet200ResponsePoemContentToJSON(value['content']),
        'file': JournalUuidGet200ResponsePoemFileToJSON(value['file']),
