 ...
 * 
 * @export
 * @interface JournalGet200ResponseMeta
 */
export interface JournalGet200ResponseMeta {
    /**
     * 
     * @type {number}
     * @memberof JournalGet200ResponseMeta
     */
    total?: number;
    /**
     * 
...
/**
 * Check if a given object implements the JournalGet200ResponseMeta interface.
 */
export function instanceOfJournalGet200ResponseMeta(value: object): value is JournalGet200ResponseMeta {
    return true;
}

export function JournalGet200ResponseMetaFromJSON(json: any): JournalGet200ResponseMeta {
    return JournalGet200ResponseMetaFromJSONTyped(json, false);
}

export function JournalGet200ResponseMetaFromJSONTyped(json: any, ignoreDiscriminator: boolean): JournalGet200ResponseMeta {
    if (json == null) {
        return json;
    }
    return {
...
export function JournalGet200ResponseMetaToJSON(json: any): JournalGet200ResponseMeta {
    return JournalGet200ResponseMetaToJSONTyped(json, false);
}

export function JournalGet200ResponseMetaToJSONTyped(value?: JournalGet200ResponseMeta | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
