 ...
 * 
 * @export
 * @interface PoemPost202Response
 */
export interface PoemPost202Response {
    /**
     * 
     * @type {string}
     * @memberof PoemPost202Response
     */
    jobId?: string;
    /**
     * 
...
/**
 * Check if a given object implements the PoemPost202Response interface.
 */
export function instanceOfPoemPost202Response(value: object): value is PoemPost202Response {
    return true;
}

export function PoemPost202ResponseFromJSON(json: any): PoemPost202Response {
    return PoemPost202ResponseFromJSONTyped(json, false);
}

export function PoemPost202ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PoemPost202Response {
    if (json == null) {
        return json;
    }
    return {
...
export function PoemPost202ResponseToJSON(json: any): PoemPost202Response {
    return PoemPost202ResponseToJSONTyped(json, false);
}

export function PoemPost202ResponseToJSONTyped(value?: PoemPost202Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
