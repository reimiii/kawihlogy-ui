 ...
 * 
 * @export
 * @interface JournalGet200ResponseItemsInnerUser
 */
export interface JournalGet200ResponseItemsInnerUser {
    /**
     * 
     * @type {string}
     * @memberof JournalGet200ResponseItemsInnerUser
     */
    id?: string;
    /**
     * 
...
/**
 * Check if a given object implements the JournalGet200ResponseItemsInnerUser interface.
 */
export function instanceOfJournalGet200ResponseItemsInnerUser(value: object): value is JournalGet200ResponseItemsInnerUser {
    return true;
}

export function JournalGet200ResponseItemsInnerUserFromJSON(json: any): JournalGet200ResponseItemsInnerUser {
    return JournalGet200ResponseItemsInnerUserFromJSONTyped(json, false);
}

export function JournalGet200ResponseItemsInnerUserFromJSONTyped(json: any, ignoreDiscriminator: boolean): JournalGet200ResponseItemsInnerUser {
    if (json == null) {
        return json;
    }
    return {
...
export function JournalGet200ResponseItemsInnerUserToJSON(json: any): JournalGet200ResponseItemsInnerUser {
    return JournalGet200ResponseItemsInnerUserToJSONTyped(json, false);
}

export function JournalGet200ResponseItemsInnerUserToJSONTyped(value?: JournalGet200ResponseItemsInnerUser | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
