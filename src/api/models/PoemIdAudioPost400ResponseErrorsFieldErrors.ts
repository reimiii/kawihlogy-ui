 ...
 * 
 * @export
 * @interface PoemIdAudioPost400ResponseErrorsFieldErrors
 */
export interface PoemIdAudioPost400ResponseErrorsFieldErrors {
    /**
     * 
     * @type {Array<string>}
     * @memberof PoemIdAudioPost400ResponseErrorsFieldErrors
     */
    id?: Array<string>;
}

/**
 * Check if a given object implements the PoemIdAudioPost400ResponseErrorsFieldErrors interface.
 */
export function instanceOfPoemIdAudioPost400ResponseErrorsFieldErrors(value: object): value is PoemIdAudioPost400ResponseErrorsFieldErrors {
    return true;
}

export function PoemIdAudioPost400ResponseErrorsFieldErrorsFromJSON(json: any): PoemIdAudioPost400ResponseErrorsFieldErrors {
    return PoemIdAudioPost400ResponseErrorsFieldErrorsFromJSONTyped(json, false);
}

export function PoemIdAudioPost400ResponseErrorsFieldErrorsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PoemIdAudioPost400ResponseErrorsFieldErrors {
    if (json == null) {
        return json;
    }
    return {
...
export function PoemIdAudioPost400ResponseErrorsFieldErrorsToJSON(json: any): PoemIdAudioPost400ResponseErrorsFieldErrors {
    return PoemIdAudioPost400ResponseErrorsFieldErrorsToJSONTyped(json, false);
}

export function PoemIdAudioPost400ResponseErrorsFieldErrorsToJSONTyped(value?: PoemIdAudioPost400ResponseErrorsFieldErrors | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
