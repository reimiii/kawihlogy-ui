...
import type { JournalPost400ResponseErrorsFieldErrors } from './JournalPost400ResponseErrorsFieldErrors';
import {
    JournalPost400ResponseErrorsFieldErrorsFromJSON,
    JournalPost400ResponseErrorsFieldErrorsFromJSONTyped,
    JournalPost400ResponseErrorsFieldErrorsToJSON,
    JournalPost400ResponseErrorsFieldErrorsToJSONTyped,
} from './JournalPost400ResponseErrorsFieldErrors';

/**
 * 
 * @export
 * @interface JournalPost400ResponseErrors
 */
export interface JournalPost400ResponseErrors {
    /**
     * 
     * @type {Array<any>}
     * @memberof JournalPost400ResponseErrors
     */
    formErrors?: Array<any>;
    /**
     * 
     * @type {JournalPost400ResponseErrorsFieldErrors}
     * @memberof JournalPost400ResponseErrors
     */
    fieldErrors?: JournalPost400ResponseErrorsFieldErrors;
}

/**
 * Check if a given object implements the JournalPost400ResponseErrors interface.
 */
export function instanceOfJournalPost400ResponseErrors(value: object): value is JournalPost400ResponseErrors {
    return true;
}

export function JournalPost400ResponseErrorsFromJSON(json: any): JournalPost400ResponseErrors {
    return JournalPost400ResponseErrorsFromJSONTyped(json, false);
}

export function JournalPost400ResponseErrorsFromJSONTyped(json: any, ignoreDiscriminator: boolean): JournalPost400ResponseErrors {
    if (json == null) {
        return json;
    }
    return {
        ...
        'fieldErrors': json['fieldErrors'] == null ? undefined : JournalPost400ResponseErrorsFieldErrorsFromJSON(json['fieldErrors']),
    };
}

export function JournalPost400ResponseErrorsToJSON(json: any): JournalPost400ResponseErrors {
    return JournalPost400ResponseErrorsToJSONTyped(json, false);
}

export function JournalPost400ResponseErrorsToJSONTyped(value?: JournalPost400ResponseErrors | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'fieldErrors': JournalPost400ResponseErrorsFieldErrorsToJSON(value['fieldErrors']),
    };
}
