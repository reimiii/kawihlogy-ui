 ...
 * 
 * @export
 * @interface AuthProfileGet200Response
 */
export interface AuthProfileGet200Response {
    /**
     * 
     * @type {string}
     * @memberof AuthProfileGet200Response
     */
    id?: string;
    /**
     * 
...
/**
 * Check if a given object implements the AuthProfileGet200Response interface.
 */
export function instanceOfAuthProfileGet200Response(value: object): value is AuthProfileGet200Response {
    return true;
}

export function AuthProfileGet200ResponseFromJSON(json: any): AuthProfileGet200Response {
    return AuthProfileGet200ResponseFromJSONTyped(json, false);
}

export function AuthProfileGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthProfileGet200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function AuthProfileGet200ResponseToJSON(json: any): AuthProfileGet200Response {
    return AuthProfileGet200ResponseToJSONTyped(json, false);
}

export function AuthProfileGet200ResponseToJSONTyped(value?: AuthProfileGet200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
