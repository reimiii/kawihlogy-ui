...
import type { PoemIdAudioPost400ResponseErrors } from './PoemIdAudioPost400ResponseErrors';
import {
    PoemIdAudioPost400ResponseErrorsFromJSON,
    PoemIdAudioPost400ResponseErrorsFromJSONTyped,
    PoemIdAudioPost400ResponseErrorsToJSON,
    PoemIdAudioPost400ResponseErrorsToJSONTyped,
} from './PoemIdAudioPost400ResponseErrors';

/**
 * 
 * @export
 * @interface PoemIdAudioPost400Response
 */
export interface PoemIdAudioPost400Response {
    /**
     * 
     * @type {number}
     * @memberof PoemIdAudioPost400Response
     */
    statusCode?: number;
    /**
     * 
    ...
    /**
     * 
     * @type {PoemIdAudioPost400ResponseErrors}
     * @memberof PoemIdAudioPost400Response
     */
    errors?: PoemIdAudioPost400ResponseErrors;
}

/**
 * Check if a given object implements the PoemIdAudioPost400Response interface.
 */
export function instanceOfPoemIdAudioPost400Response(value: object): value is PoemIdAudioPost400Response {
    return true;
}

export function PoemIdAudioPost400ResponseFromJSON(json: any): PoemIdAudioPost400Response {
    return PoemIdAudioPost400ResponseFromJSONTyped(json, false);
}

export function PoemIdAudioPost400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PoemIdAudioPost400Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'errors': json['errors'] == null ? undefined : PoemIdAudioPost400ResponseErrorsFromJSON(json['errors']),
    };
}

export function PoemIdAudioPost400ResponseToJSON(json: any): PoemIdAudioPost400Response {
    return PoemIdAudioPost400ResponseToJSONTyped(json, false);
}

export function PoemIdAudioPost400ResponseToJSONTyped(value?: PoemIdAudioPost400Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'errors': PoemIdAudioPost400ResponseErrorsToJSON(value['errors']),
    };
}
