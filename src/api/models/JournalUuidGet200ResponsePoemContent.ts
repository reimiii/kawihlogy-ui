 ...
 * 
 * @export
 * @interface JournalUuidGet200ResponsePoemContent
 */
export interface JournalUuidGet200ResponsePoemContent {
    /**
     * 
     * @type {string}
     * @memberof JournalUuidGet200ResponsePoemContent
     */
    title?: string;
    /**
     * 
...
/**
 * Check if a given object implements the JournalUuidGet200ResponsePoemContent interface.
 */
export function instanceOfJournalUuidGet200ResponsePoemContent(value: object): value is JournalUuidGet200ResponsePoemContent {
    return true;
}

export function JournalUuidGet200ResponsePoemContentFromJSON(json: any): JournalUuidGet200ResponsePoemContent {
    return JournalUuidGet200ResponsePoemContentFromJSONTyped(json, false);
}

export function JournalUuidGet200ResponsePoemContentFromJSONTyped(json: any, ignoreDiscriminator: boolean): JournalUuidGet200ResponsePoemContent {
    if (json == null) {
        return json;
    }
    return {
        ...
        'stanzas': json['stanzas'] == null ? undefined : json['stanzas'],
    };
}

export function JournalUuidGet200ResponsePoemContentToJSON(json: any): JournalUuidGet200ResponsePoemContent {
    return JournalUuidGet200ResponsePoemContentToJSONTyped(json, false);
}

export function JournalUuidGet200ResponsePoemContentToJSONTyped(value?: JournalUuidGet200ResponsePoemContent | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
