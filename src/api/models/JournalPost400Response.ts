...
import type { JournalPost400ResponseErrors } from './JournalPost400ResponseErrors';
import {
    JournalPost400ResponseErrorsFromJSON,
    JournalPost400ResponseErrorsFromJSONTyped,
    JournalPost400ResponseErrorsToJSON,
    JournalPost400ResponseErrorsToJSONTyped,
} from './JournalPost400ResponseErrors';

/**
 * 
 * @export
 * @interface JournalPost400Response
 */
export interface JournalPost400Response {
    /**
     * 
     * @type {number}
     * @memberof JournalPost400Response
     */
    statusCode?: number;
    /**
     * 
    ...
    /**
     * 
     * @type {JournalPost400ResponseErrors}
     * @memberof JournalPost400Response
     */
    errors?: JournalPost400ResponseErrors;
}

/**
 * Check if a given object implements the JournalPost400Response interface.
 */
export function instanceOfJournalPost400Response(value: object): value is JournalPost400Response {
    return true;
}

export function JournalPost400ResponseFromJSON(json: any): JournalPost400Response {
    return JournalPost400ResponseFromJSONTyped(json, false);
}

export function JournalPost400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): JournalPost400Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'errors': json['errors'] == null ? undefined : JournalPost400ResponseErrorsFromJSON(json['errors']),
    };
}

export function JournalPost400ResponseToJSON(json: any): JournalPost400Response {
    return JournalPost400ResponseToJSONTyped(json, false);
}

export function JournalPost400ResponseToJSONTyped(value?: JournalPost400Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'errors': JournalPost400ResponseErrorsToJSON(value['errors']),
    };
}
