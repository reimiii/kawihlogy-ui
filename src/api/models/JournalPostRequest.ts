...
/**
 * Check if a given object implements the JournalPostRequest interface.
 */
export function instanceOfJournalPostRequest(value: object): value is JournalPostRequest {
    return true;
}

export function JournalPostRequestFromJSON(json: any): JournalPostRequest {
    return JournalPostRequestFromJSONTyped(json, false);
}

export function JournalPostRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): JournalPostRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function JournalPostRequestToJSON(json: any): JournalPostRequest {
    return JournalPostRequestToJSONTyped(json, false);
}

export function JournalPostRequestToJSONTyped(value?: JournalPostRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
