 ...
 * 
 * @export
 * @interface PoemPostRequest
 */
export interface PoemPostRequest {
    /**
     * 
     * @type {string}
     * @memberof PoemPostRequest
     */
    journalId?: string;
}

/**
 * Check if a given object implements the PoemPostRequest interface.
 */
export function instanceOfPoemPostRequest(value: object): value is PoemPostRequest {
    return true;
}

export function PoemPostRequestFromJSON(json: any): PoemPostRequest {
    return PoemPostRequestFromJSONTyped(json, false);
}

export function PoemPostRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PoemPostRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function PoemPostRequestToJSON(json: any): PoemPostRequest {
    return PoemPostRequestToJSONTyped(json, false);
}

export function PoemPostRequestToJSONTyped(value?: PoemPostRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
