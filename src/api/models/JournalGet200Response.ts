...
import type { JournalGet200ResponseMeta } from './JournalGet200ResponseMeta';
import {
    JournalGet200ResponseMetaFromJSON,
    JournalGet200ResponseMetaFromJSONTyped,
    JournalGet200ResponseMetaToJSON,
    JournalGet200ResponseMetaToJSONTyped,
} from './JournalGet200ResponseMeta';
import type { JournalGet200ResponseItemsInner } from './JournalGet200ResponseItemsInner';
import {
    JournalGet200ResponseItemsInnerFromJSON,
    JournalGet200ResponseItemsInnerFromJSONTyped,
    JournalGet200ResponseItemsInnerToJSON,
    JournalGet200ResponseItemsInnerToJSONTyped,
} from './JournalGet200ResponseItemsInner';

/**
 * 
 * @export
 * @interface JournalGet200Response
 */
export interface JournalGet200Response {
    /**
     * 
     * @type {Array<JournalGet200ResponseItemsInner>}
     * @memberof JournalGet200Response
     */
    items?: Array<JournalGet200ResponseItemsInner>;
    /**
     * 
     * @type {JournalGet200ResponseMeta}
     * @memberof JournalGet200Response
     */
    meta?: JournalGet200ResponseMeta;
}

/**
 * Check if a given object implements the JournalGet200Response interface.
 */
export function instanceOfJournalGet200Response(value: object): value is JournalGet200Response {
    return true;
}

export function JournalGet200ResponseFromJSON(json: any): JournalGet200Response {
    return JournalGet200ResponseFromJSONTyped(json, false);
}

export function JournalGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): JournalGet200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'items': json['items'] == null ? undefined : ((json['items'] as Array<any>).map(JournalGet200ResponseItemsInnerFromJSON)),
        'meta': json['meta'] == null ? undefined : JournalGet200ResponseMetaFromJSON(json['meta']),
    };
}

export function JournalGet200ResponseToJSON(json: any): JournalGet200Response {
    return JournalGet200ResponseToJSONTyped(json, false);
}

export function JournalGet200ResponseToJSONTyped(value?: JournalGet200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': value['items'] == null ? undefined : ((value['items'] as Array<any>).map(JournalGet200ResponseItemsInnerToJSON)),
        'meta': JournalGet200ResponseMetaToJSON(value['meta']),
    };
}
