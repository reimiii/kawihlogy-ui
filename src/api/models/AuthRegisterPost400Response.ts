...
import type { AuthRegisterPost400ResponseErrors } from './AuthRegisterPost400ResponseErrors';
import {
    AuthRegisterPost400ResponseErrorsFromJSON,
    AuthRegisterPost400ResponseErrorsFromJSONTyped,
    AuthRegisterPost400ResponseErrorsToJSON,
    AuthRegisterPost400ResponseErrorsToJSONTyped,
} from './AuthRegisterPost400ResponseErrors';

/**
 * 
 * @export
 * @interface AuthRegisterPost400Response
 */
export interface AuthRegisterPost400Response {
    /**
     * 
     * @type {number}
     * @memberof AuthRegisterPost400Response
     */
    statusCode?: number;
    /**
     * 
    ...
    /**
     * 
     * @type {AuthRegisterPost400ResponseErrors}
     * @memberof AuthRegisterPost400Response
     */
    errors?: AuthRegisterPost400ResponseErrors;
}

/**
 * Check if a given object implements the AuthRegisterPost400Response interface.
 */
export function instanceOfAuthRegisterPost400Response(value: object): value is AuthRegisterPost400Response {
    return true;
}
...
export function AuthRegisterPost400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthRegisterPost400Response {
    ...
    return {
        ...
        'errors': json['errors'] == null ? undefined : AuthRegisterPost400ResponseErrorsFromJSON(json['errors']),
    };
}

export function AuthRegisterPost400ResponseToJSON(json: any): AuthRegisterPost400Response {
...
export function AuthRegisterPost400ResponseToJSONTyped(value?: AuthRegisterPost400Response | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'errors': AuthRegisterPost400ResponseErrorsToJSON(value['errors']),
    };
}
