 ...
 */
export function instanceOfJournalUuidGet200Response(
  value: object,
): value is JournalUuidGet200Response {
  return true;
}

export function JournalUuidGet200ResponseFromJSON(
  json: any,
): JournalUuidGet200Response {
  return JournalUuidGet200ResponseFromJSONTyped(json, false);
}

export function JournalUuidGet200ResponseFromJSONTyped(
  json: any,
  ...
  return {
    ...
    poem:
      json["poem"] == null
        ? undefined
        : JournalUuidGet200ResponsePoemFromJSON(json["poem"]),
    user:
      json["user"] == null
        ? undefined
        : JournalGet200ResponseItemsInnerUserFromJSON(json["user"]),
  };
}

export function JournalUuidGet200ResponseToJSON(
  json: any,
): JournalUuidGet200Response {
  return JournalUuidGet200ResponseToJSONTyped(json, false);
}

export function JournalUuidGet200ResponseToJSONTyped(
  value?: JournalUuidGet200Response | null,
