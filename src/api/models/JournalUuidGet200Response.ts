...
import type { JournalGet200ResponseItemsInnerUser } from './JournalGet200ResponseItemsInnerUser';
import {
    JournalGet200ResponseItemsInnerUserFromJSON,
    JournalGet200ResponseItemsInnerUserFromJSONTyped,
    JournalGet200ResponseItemsInnerUserToJSON,
    JournalGet200ResponseItemsInnerUserToJSONTyped,
} from './JournalGet200ResponseItemsInnerUser';
import type { JournalUuidGet200ResponsePoem } from './JournalUuidGet200ResponsePoem';
import {
    JournalUuidGet200ResponsePoemFromJSON,
    JournalUuidGet200ResponsePoemFromJSONTyped,
    JournalUuidGet200ResponsePoemToJSON,
    JournalUuidGet200ResponsePoemToJSONTyped,
} from './JournalUuidGet200ResponsePoem';

/**
 * 
 * @export
 * @interface JournalUuidGet200Response
 */
export interface JournalUuidGet200Response {
    /**
     * 
     * @type {string}
     * @memberof JournalUuidGet200Response
     */
    id?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {JournalUuidGet200ResponsePoem}
     * @memberof JournalUuidGet200Response
     */
    poem?: JournalUuidGet200ResponsePoem;
    /**
     * 
     * @type {JournalGet200ResponseItemsInnerUser}
     * @memberof JournalUuidGet200Response
     */
    user?: JournalGet200ResponseItemsInnerUser;
}

/**
 * Check if a given object implements the JournalUuidGet200Response interface.
 */
export function instanceOfJournalUuidGet200Response(value: object): value is JournalUuidGet200Response {
    return true;
}

export function JournalUuidGet200ResponseFromJSON(json: any): JournalUuidGet200Response {
    return JournalUuidGet200ResponseFromJSONTyped(json, false);
}

export function JournalUuidGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): JournalUuidGet200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'poem': json['poem'] == null ? undefined : JournalUuidGet200ResponsePoemFromJSON(json['poem']),
        'user': json['user'] == null ? undefined : JournalGet200ResponseItemsInnerUserFromJSON(json['user']),
    };
}

export function JournalUuidGet200ResponseToJSON(json: any): JournalUuidGet200Response {
    return JournalUuidGet200ResponseToJSONTyped(json, false);
}

export function JournalUuidGet200ResponseToJSONTyped(value?: JournalUuidGet200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'poem': JournalUuidGet200ResponsePoemToJSON(value['poem']),
        'user': JournalGet200ResponseItemsInnerUserToJSON(value['user']),
    };
}
