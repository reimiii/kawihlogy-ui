 ...
 * 
 * @export
 * @interface AuthRegisterPost422Response
 */
export interface AuthRegisterPost422Response {
    /**
     * 
     * @type {string}
     * @memberof AuthRegisterPost422Response
     */
    message?: string;
    /**
     * 
...
/**
 * Check if a given object implements the AuthRegisterPost422Response interface.
 */
export function instanceOfAuthRegisterPost422Response(value: object): value is AuthRegisterPost422Response {
    return true;
}

export function AuthRegisterPost422ResponseFromJSON(json: any): AuthRegisterPost422Response {
    return AuthRegisterPost422ResponseFromJSONTyped(json, false);
}

export function AuthRegisterPost422ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthRegisterPost422Response {
    if (json == null) {
        return json;
    }
    return {
...
export function AuthRegisterPost422ResponseToJSON(json: any): AuthRegisterPost422Response {
    return AuthRegisterPost422ResponseToJSONTyped(json, false);
}

export function AuthRegisterPost422ResponseToJSONTyped(value?: AuthRegisterPost422Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
